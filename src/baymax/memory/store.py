    ...
    def __init__(self, path: Path):
        ...
        with self.connect() as db:
            db.executescript("""
              ...
              CREATE TABLE IF NOT EXISTS appointments(id INTEGER PRIMARY KEY, title TEXT NOT NULL, scheduled_at TEXT NOT NULL, note TEXT NOT NULL DEFAULT '');
              CREATE TABLE IF NOT EXISTS wellness_notes(id INTEGER PRIMARY KEY, note TEXT NOT NULL, created_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP);
            """)
